...
- Project Run: bootstrap/context instruct the agent to pause after finishing major tasks or tool batches to answer user questions and summarize progress before continuing.
