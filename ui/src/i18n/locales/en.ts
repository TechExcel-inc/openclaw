...
export const en: TranslationMap = {
  ...
  nav: {
    ...
    agent: "Agent",
    settings: "Settings",
    projectTemplates: "Test Plan",
    projectExecute: "Test Run",
    workspace: "EAD-Test Workspace",
    expand: "Expand sidebar",
    collapse: "Collapse sidebar",
    resize: "Resize sidebar",
  },
  tabs: {
    projects: "Test Plan Project",
    autoTestRun: "Test Run Project",
    agents: "Agents",
    overview: "Overview",
    channels: "Channels",
    instances: "Instances",
  ...
  subtitles: {
    projects: "Manage your test plan blueprints and test suites.",
    autoTestRun: "Watch live executions and review historical test results.",
